    ...
    <div class="container d-flex align-items-center" >
      ...
      <nav class="nav-menu d-none d-lg-block" style="float: right; ">
        ...
        ?>
          ...
          <li><a href="" style="text-decoration: none; ">Reports</a></li>
          <?php if (isset($_SESSION['user_id'])) { ?>
...
<!-- ======= Hero Section ======= -->
<section id="hero" class="d-flex align-items-center" style="background-image: url(assets/img/reports.jpeg); background-repeat: no-repeat; background-size: cover; background-position: center;position: relative;">

<div class="container">
  <div class="row">
    <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
      <h1>COMPLETED EVENTS</h1>
      <h2>Reports about completed events in our college.</h2>
    </div>
