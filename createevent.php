...
if (isset($_POST['create'])) {
    ...
    $count = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM events"));
    $eventid= $count+1;        
                 
    $insQuery = "INSERT INTO `events` (`EventId`, `EventName`, `HostId`, `Date`, `EndDate`, `Description`, `Level`) VALUES( '".$eventid."',  '".$name."' , '".$_SESSION['user_id']."' ,'".$date."' , '".$enddate."' , '".$desc."' ,  '".$level."')";
     echo mysqli_query($conn, $insQuery);
    ...
    <div class="container d-flex align-items-center" >
      ...
      <nav class="nav-menu d-none d-lg-block" style="float: right; ">
        ...
        <?php if (isset($_SESSION['user_id'])) { 
            if ($_SESSION['type']=='host') {?>
        <li ><a href="" style="text-decoration: none;">Create Event</a></li>
			...
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">
				<fieldset>
					<div class="form-group">
						...
						<input type="text" name="name" placeholder="Enter Name" required value="" class="form-control" />
					</div>					
					<div class="form-group">
